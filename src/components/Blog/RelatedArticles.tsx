...
export function RelatedArticles({ articles, currentSlug }: RelatedArticlesProps) {
  ...
  return (
    <section>
      <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-8">Related Articles</h3>
        ...
        {filteredArticles.map(article => (
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm line-clamp-3 mb-4">{article.excerpt}</p>
