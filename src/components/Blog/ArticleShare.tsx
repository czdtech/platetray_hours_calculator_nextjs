 ...
 * 文章分享按钮组
 */
export function ArticleShare({ title, url, locale = "en", messages }: ArticleShareProps) {
  ...
  const shareOnLabel = (platform: string) =>
    t(resolvedMessages.blog.shareOn, { platform });
        ...
        navigator.clipboard
          ...
          .then(() => {
            ...
            if (button) {
              ...
              button.setAttribute("aria-label", resolvedMessages.blog.linkCopied);
              button.style.color = "#10b981";
              setTimeout(() => {
                button.setAttribute(
                  "aria-label",
                  originalText || resolvedMessages.blog.copyLink,
                );
                button.style.color = "";
              }, 2000);
            }
          ...
          .catch(() => {
            alert(resolvedMessages.blog.copyError);
          });
        break;
      }
    }
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between">
          ...
          <div className="flex space-x-4">
            ...
            <button
              ...
              aria-label={shareOnLabel("Facebook")}
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
            ...
            <button
              ...
              aria-label={shareOnLabel("WhatsApp")}
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              aria-label={shareOnLabel("Telegram")}
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              aria-label={resolvedMessages.blog.copyLink}
            >
