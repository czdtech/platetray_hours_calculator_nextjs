...
export function CityInfo({ city, sunrise, sunset, timezone, dayRuler }: CityInfoProps) {
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
            Planetary Hours in {city.name} Today
          </h1>
        ...
        <div className="flex flex-wrap gap-4">
          <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg px-4 py-3 text-center min-w-[100px]">
            <p className="text-xs text-amber-600 dark:text-amber-400 font-medium uppercase">Sunrise</p>
          ...
          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg px-4 py-3 text-center min-w-[100px]">
            <p className="text-xs text-indigo-600 dark:text-indigo-400 font-medium uppercase">Sunset</p>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg px-4 py-3 text-center min-w-[100px]">
            <p className="text-xs text-purple-600 dark:text-purple-400 font-medium uppercase">Day Ruler</p>
            <p className={`text-lg font-semibold ${rulerColor}`}>{rulerSymbol} {dayRuler}</p>
          </div>
        </div>
      </div>

      <div className="mt-4 text-sm text-gray-600 dark:text-gray-300">
        <p>Timezone: <span className="font-medium">{timezone}</span></p>
      </div>
