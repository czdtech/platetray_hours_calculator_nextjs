...
export const metadata: Metadata = {
  ...
  description:
    "Review the terms and conditions for using the Planetary Hours Calculator.",
  alternates: {
        ...
        <Article className="bg-white rounded-xl shadow-lg p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              ...
              these restrictions and may be terminated by Planetary Hours
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Further, Planetary Hours Calculator does not warrant or make any
              representations concerning the accuracy, likely results, or
              reliability of the use of the materials on its website or
              otherwise relating to such materials or on any sites linked to
              this site. The calculations are based on traditional astrological
              methods and are provided for informational and entertainment
              purposes only. They should not be used as a substitute for
              professional advice.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              In no event shall Planetary Hours Calculator or its suppliers be
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Planetary Hours Calculator has not reviewed all of the sites
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Planetary Hours Calculator may revise these terms of service for
